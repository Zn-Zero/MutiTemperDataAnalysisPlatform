...
<template>
  <el-form :model="form" label-width="auto" style="max-width: 600px">
    ...
    <el-row gutter="20">
      ...
      <el-col :span="12">
        <el-form-item label="添加页眉">
          <el-switch v-model="form.addHeader" />
        </el-form-item>
      </el-col>
    </el-row>
    <el-row gutter="20">
    ...
    <el-row gutter="20">
      ...
      <el-col :span="6" v-if="!isBlank(form.logoPath)">
        <el-image :src="form.logoPath" style="width: 100%;" />
      </el-col>
    </el-row>
    <el-form-item>
